...
public class MainMenu extends Page {
    public MainMenu(){
        ...
        uiManager.addElement(new TimelineNode("Chadwick",670,735,200,30,7));
        uiManager.addElement(new TimelineNode("Shrödinger",410,835,200,30,8));
        uiManager.addElement(new TimelineNode("Conclusion",540,950,200,30,2));
        uiManager.addElement(new LineElement(640,300,0,650));
