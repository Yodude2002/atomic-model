...
public class ChadwickPage extends Page {
    ...
    {
        super(0xff000000);
        uiManager.addElement(new TextElement("James Chadwick", 0xffffffff, 10, 10, false));
        uiManager.addElement(new ImageElement("chadwick.jpeg",0,50,this));
        uiManager.addElement(new TextElement("Discoverer of the Neutron",0xffffffff,0,330, false){
            @Override
